...
import { ArrayUtils } from "../dist/@pure-function/jsutils.js";
...
describe("ArrayUtils tests", () => {
    ...
    describe("uniq()", () => {
        ...
        it("nested array", () => {
            expect(ArrayUtils.uniq([1, [1, 2], 3, [1, 2]])).to.deep.equal([
                1,
                [1, 2],
                3,
                [1, 2],
    ...
    describe("indexOf()", () => {
        ...
        it("array with null & undefined", () => {
            expect(
                ArrayUtils.indexOf([1, "a", null, undefined, "k"], "k")
            ).to.equal(4);
        });
        it("array with no key", () => {
            expect(
                ArrayUtils.indexOf([1, "a", null, undefined, "k"], "k1")
            ).to.equal(-1);
        });
